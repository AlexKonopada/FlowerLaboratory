...
public class Store {
    ...
    public ArrayList<Flower>
    makeFlowerPurchase (int minPrice, int maxPrice) {
    ...
    public ArrayList<FlowerPack>
    makeFlowerPackPurchase (int minPrice, int maxPrice) {
        if (!this.flowerPackList.isEmpty()) {
            this.flowerPackList.clear();
        }
        for (FlowerPack flowerPack: flowerPackList) {
            if (flowerPack.getPrice() >= minPrice && flowerPack.getPrice() <= maxPrice) {
    ...
    public ArrayList<FlowerBucket>
    makeFlowerBucketPurchase(int minPrice, int maxPrice) {
